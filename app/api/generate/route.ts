...
async function generateWithClaude(
  ...
  const systemPrompt = `あなたは正確な年表と有名人の情報を生成するアシスタントです。
以下の重要な注意事項を必ず守ってください：

【重要】事実確認について：
- 有名人の誕生日は必ず正確に確認してください
- 存在しない人物や架空の人物は含めないでください
- 不確実な情報は含めず、確実に正しい情報のみを提供してください
- 有名人の代表作や職業も正確に記載してください

【生成する情報】：
1. 同じ誕生日（月日）の実在する有名人を3-4名（確実に正確な情報のみ）
2. ユーザーの生まれ年から現在までの主要な歴史的出来事の年表

【年表の注意事項】：
- 歴史的事実を正確に記載してください
- 年代は必ず正確に確認してください
- 個人の誕生については「○月○日、この世に生まれる」という表現を使用してください
...
【要求内容】：
1. ${birthMonth}月${birthDay}日生まれの実在する有名人3-4名を正確な情報で提供
2. ${birthYear}年から現在（${currentYear}年）までの主要な歴史的出来事を年代順に

【必須確認事項】：
- 有名人の誕生日は${birthMonth}月${birthDay}日で間違いないか
- 代表作や職業情報は正確か
- 歴史的事件の年代は正確か
